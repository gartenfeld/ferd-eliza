...
module.elizaInitials = elizaInitials = [
...
module.elizaFinals = elizaFinals = [
"Goodbye. It was nice talking to you.",
// additions (not original)
"Goodbye. This was really a nice talk.",
"Goodbye. I'm looking forward to our next session.",
"It was a good session.",
"Maybe we could discuss this moreover in our next session."
];

module.elizaQuits = elizaQuits = [
"bye",
"goodbye",
"done",
"exit",
...
module.elizaSynons = elizaSynons = {
"be": ["am", "is", "are", "was"],
...
module.elizaKeywords = elizaKeywords = [
...
module.elizaPostTransforms = elizaPostTransforms = [
	/ old old/g, " old",
...
ElizaBot.prototype._init = function() {
	...
	var global=ElizaBot.prototype.global=module;
	// parse data and convert it from canonical form to internal use
	// prodoce synonym list
	var synPatterns={};
	if ((global.elizaSynons) && (typeof elizaSynons == 'object')) {
		for (var syn in elizaSynons) synPatterns[syn]='('+syn+'|'+elizaSynons[syn].join('|')+')';
	}
